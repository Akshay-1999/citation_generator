...
async def main():
    ...
    # List of 10 resumes (mock names for demonstration)
    file_names = [
        "Naukri_SrikanthN[8y_0m].pdf",
        "Naukri_UjjwalGupta[10y_0m] (1).pdf",
        "AsifKalam_Fullstack.pdf",
        "Akshay Patil Resume.pdf"
        # "Resume_4.pdf", "Resume_5.pdf", ... up to 10
    ]
    
    user_id = "ac68c8ac-0c3d-458c-bd2e-b707c278f7f1"
    output_filename = "bulk_screening_results.xlsx"
    
    await process_resumes_to_excel(jd, file_names, user_id, output_filename)
